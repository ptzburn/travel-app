...
type SortByOption = LocationFilters["sortBy"];
type SortDirection = LocationFilters["sortDirection"];
...
const defaultFilters = defaultLocationFilters;
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-end">
      <TextField class="flex-1" value={search()} onChange={handleSearchInput}>
        <div class="relative">
          ...
          <TextFieldInput placeholder="Search locations..." class="pl-9" />
        </div>
      </TextField>
